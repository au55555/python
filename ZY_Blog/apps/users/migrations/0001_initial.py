    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nick_name', models.CharField(default='KPzj0Gv2', max_length=50, verbose_name='昵称')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_use', models.BooleanField(choices=[(True, '已使用'), (False, '未使用')], default=False, verbose_name='是否使用')),
